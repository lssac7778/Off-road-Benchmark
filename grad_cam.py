...
class _BaseWrapper(object):
    ...
    def forward(self, image, y):
        ...
        self.logits = self.model(image, y)[0]
        return self.logits
    ...
    def backward(self):
        ...
        back = self.logits.mean()
        back.backward(retain_graph=True)
...
class BackPropagation(_BaseWrapper):
    def forward(self, image, y):
        ...
        self.y = y.requires_grad_()
        return super(BackPropagation, self).forward(self.image, y)
